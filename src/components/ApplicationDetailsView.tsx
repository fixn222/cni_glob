import { BriefcaseBusiness, CalendarDays, CheckCircle2, FileText, Globe2, PlaneTakeoff, ShieldCheck, UserRound } from "lucide-react";

import type { Country } from "../pages/Countries";
...
const ApplicationDetailsView = ({
  ...
  return (
    <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/8 shadow-2xl backdrop-blur-2xl">
          ...
          <section className="rounded-[1.5rem] border border-white/10 bg-background/70 p-5 sm:p-6">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <label className="space-y-2">
                ...
                <select className="flex h-12 w-full rounded-xl border border-input bg-white/60 px-4 text-sm outline-none transition focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 dark:bg-background/40">
              ...
              <label className="space-y-2">
                <span className="text-sm font-medium">Travel purpose</span>
                <select className="flex h-12 w-full rounded-xl border border-input bg-white/60 px-4 text-sm outline-none transition focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 dark:bg-background/40">
              ...
              <label className="space-y-2">
                <span className="text-sm font-medium">Intended travel date</span>
                <Input
                  type="date"
                  className="h-12 rounded-xl bg-white/60 px-4 dark:bg-background/40"
                />
